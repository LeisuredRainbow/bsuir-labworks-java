...
Git
    ...
    Репозиторий инициализирован, есть .gitignore.

    README оформлен.

    Код соответствует требованиям лабораторной.

SonarCloud

На данный момент SonarCloud не подключён (будет настроен в ЛР 8). Код проверен с помощью SonarLint, критические замечания отсутствуют.
